...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE "+TB_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,USERNAME TEXT,PASSWORD TEXT,COUNT INTEGER)");
        db.execSQL("CREATE TABLE "+JTB_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT,JDATE TEXT,JCONTEXT TEXT,JLEIBIE INTEGER,JZHUANGTAI INTEGER)");
